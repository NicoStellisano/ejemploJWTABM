...
$app->group('/empleado', function () {
  ...
  $this->post('/', \empleadoApi::class . ':CargarUno')->add(\MWparaCORS::class . ':HabilitarCORSTodos')->add(\MWparaAutentificar::class . ':VerificarUsuario');

  $this->post('/login', \empleadoApi::class . ':Logearse')->add(\MWparaCORS::class . ':HabilitarCORSTodos');
  

  $this->delete('/', \empleadoApi::class . ':BorrarUno')->add(\MWparaAutentificar::class . ':VerificarUsuario');

  $this->put('/', \empleadoApi::class . ':ModificarUno')->add(\MWparaCORS::class . ':HabilitarCORSTodos')->add(\MWparaAutentificar::class . ':VerificarUsuario');
...
if( $usuario &&  $clave )
{
    ...
    if( Empleado::esValido($usuario,$clave,$tipo))
    {
      $datos=array('usuario'=>$usuario,'clave'=>$clave,'tipo'=>$tipo);
...
$app->group('/login', function () {
  $this->post('/', \empleadoApi::class . ':Logearse')->add(\MWparaCORS::class . ':HabilitarCORSTodos');
 });
